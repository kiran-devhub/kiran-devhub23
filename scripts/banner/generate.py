...
SOURCE = ROOT / "assets/source/kiran.png"
ASSETS = ROOT / "assets"
...
ROWS = [
    ...
    ("Focus", "Secure Web Apps · Cybersecurity"),
    ("Status", "Building + Learning + Shipping"),
    ("ToolChain", "VS Code · Git · Postman"),
    ("Core.Lang", "JavaScript · TypeScript · Python"),
    ("Core.Frontend", "React · Next.js · HTML · Tailwind"),
    ("Core.Backend", "Node.js · Express · REST · JWT"),
    ("Core.Database", "MongoDB · MySQL · Supabase"),
    ("Core.Infra", "Vercel · Netlify · GitHub Pages"),
    ("Security", "OWASP Top 10 · Secure Auth · bcrypt"),
    ("Grid.GitHub", "kiran-devhub"),
    ("Grid.Mail", "kiran.devhub@gmail.com"),
    ("Grid.Web", "kkbportfolio.vercel.app"),
]
...
def make_logos() -> dict[str, Image.Image]:
    """Create security/development silhouettes for the morph animation."""
    ...
    pts = [(200, 45), (325, 90), (305, 245), (200, 350), (95, 245), (75, 90)]
    d.polygon(pts, fill="black")
    d.polygon([(200, 90), (285, 118), (270, 225), (200, 295), (130, 225), (115, 118)], fill=(0,0,0,0))
    d.line([(135,200),(180,245),(270,150)], fill="black", width=28, joint="curve")
    logos["shield"] = shield

    # Terminal prompt / angle brackets
    terminal = Image.new("RGBA", (size, size), (0, 0, 0, 0))
    d = ImageDraw.Draw(terminal)
    d.line([(75, 105),(170,200),(75,295)], fill="black", width=38, joint="curve")
    d.line([(325,105),(230,200),(325,295)], fill="black", width=38, joint="curve")
    d.line([(190,315),(210,85)], fill="black", width=34)
    logos["terminal"] = terminal

    # Lock / authentication symbol
    lock = Image.new("RGBA", (size, size), (0, 0, 0, 0))
    d = ImageDraw.Draw(lock)
    d.rounded_rectangle((85,155,315,335), radius=28, fill="black")
    d.arc((120,55,280,245), 180, 360, fill="black", width=42)
    d.rectangle((182,215,218,285), fill=(0,0,0,0))
    d.ellipse((182,210,218,246), fill=(0,0,0,0))
    logos["lock"] = lock
...
def render_svg(
    ...
    shield = transport(source, logo_points["shield"][:n])
    terminal = transport(shield, logo_points["terminal"][:n])
    lock = transport(terminal, logo_points["lock"][:n])
    ...
    frames = [source, source, shield, shield, terminal, terminal, lock, lock, source]
    ...
    parts: list[str] = [
        ...
        "<title id=\"title\">Kiran's live system profile</title>",
        '<desc id="desc">Animated terminal profile with a dithered portrait and '
        "shield, terminal, and authentication-lock silhouettes.</desc>",
        "<defs>",
    ...
    shield_centroid = shield.mean(axis=0)
    ...
    for band in range(94):
        ...
        delta = (shield_centroid - centroid) * 0.18 + noise[band]
        d = point_path(pts)
        parts.append(
    ...
    parts.extend(
        [
            ...
            'font-weight="700">@kiran-devhub</text>',
        ]
    )
